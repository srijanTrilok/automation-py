...
def file_process(event):
    ...
    q = 'select a.*, b.* from machine_lookup a, "iss_usage_2012_q1" b where a.machine_type = b.machine_name_matched;'
    ...
    FE.to_sql('test', con=engine, schema='public', if_exists='replace')
    print "done"
